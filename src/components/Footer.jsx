        ...
        <div class="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
          <div class="text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 sm:text-5xl">
              Vinit Auto Cunsultants
            </h2>

            <p class="mx-auto mt-4 max-w-sm text-gray-500">
              Vinit Car Seller & Consultants ke saath paaiye perfect second-hand
              car. Hum aapki need ke hisaab se best budget, best condition aur
              trusted cars suggest karte hain.
            </p>

            <p class="mx-auto mt-4 max-w-m text-gray-500">
            ...
            <a
              ...
              className="mt-8 inline-block rounded-full border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white transition"
            >
              Contact Us
            </a>
          </div>
            ...
            <ul class="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
              ...
              <li>
                <SignInButton mode="modal" forceRedirectUrl="/" asChild>
                  <span className="cursor-pointer text-gray-700 hover:text-gray-700/75">
                    Log In
                  </span>
                </SignInButton>
              </li>
